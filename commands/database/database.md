...
Configure a database container. Follow these steps:
...
Read the Docker patterns skill for database container configurations:
- `skills/devops/docker-patterns/SKILL.md` for complete configurations
