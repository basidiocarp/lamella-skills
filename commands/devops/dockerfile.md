...
Generate an optimized Dockerfile. Follow these steps:
...
Read the Docker patterns skill for Dockerfile best practices:
- `skills/devops/docker-patterns/SKILL.md` for complete Dockerfile patterns
