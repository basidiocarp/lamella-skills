...
Set up SSL/TLS for Docker services. Follow these steps:
...
Read the Docker patterns skill for SSL and port configuration:
- `skills/devops/docker-patterns/SKILL.md` for complete SSL configurations
