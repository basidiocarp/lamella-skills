...
- Use standard template from `.claude/skills/meta/file-todos/assets/todo-template.md`
...
2. Use file-todos skill for structured todo management:
   ...
   - Template location: `.claude/skills/meta/file-todos/assets/todo-template.md`
...
5. Follow template structure from file-todos skill: `.claude/skills/meta/file-todos/assets/todo-template.md`
