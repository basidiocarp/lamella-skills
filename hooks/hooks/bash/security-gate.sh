...
# ─────────────────────────────────────────────────────────────────────────────
if echo "$CONTENT" | grep -qE "\.innerHTML\s*=\s*[^\"'${BT}]|document\.write\s*\("; then
...
# ─────────────────────────────────────────────────────────────────────────────
if echo "$CONTENT" | grep -qE "eval\s*\(\s*[^\"'${BT}]|new\s+Function\s*\(\s*[^\"'${BT}]"; then
...
# ─────────────────────────────────────────────────────────────────────────────
if echo "$CONTENT" | grep -qE "(exec|shell_exec|system|popen|subprocess\.call)\s*\([^\"'${BT}].*(\\\$\{|'\s*\+|\"\s*\+)"; then
