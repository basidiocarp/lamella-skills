...
Complete reference for the Task system used in swarm orchestration.
...
Location: `~/.claude/tasks/{team-name}/1.json`
...
| `owner` | string | Agent name claiming this task |
| `activeForm` | string | Message shown in spinner |
