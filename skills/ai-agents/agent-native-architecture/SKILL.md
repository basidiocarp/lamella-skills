...
The Claude Code SDK makes this accessible. Build applications where features aren't code you write—they're outcomes you describe, achieved by an agent with tools, operating in a loop until the outcome is reached.
...
**With atomic tools and parity, create new features just by writing new prompts.**
...
**This works for developers and users.** ship new features by adding prompts. Users can customize behavior by modifying prompts or creating their own. "When I say 'file this,' always move it to my Action folder and tag it urgent" becomes a user-level prompt that extends the application.
...
**This reveals latent demand.** Instead of guessing what features users want, you observe what they're asking the agent to do. When patterns emerge, optimize them with domain-specific tools or dedicated prompts. But you didn't have to anticipate them—you discovered them.
...
- [Core Principles](#core-principles)
  - [1. Parity](#1-parity)
  - [2. Granularity](#2-granularity)
  - [3. Composability](#3-composability)
  - [4. Emergent Capability](#4-emergent-capability)
  - [5. Improvement Over Time](#5-improvement-over-time)
...
- [Anti-Patterns](#anti-patterns)
  - [Common Approaches That Aren't Fully Agent-Native](#common-approaches-that-arent-fully-agent-native)
  - [Specific Anti-Patterns](#specific-anti-patterns)
