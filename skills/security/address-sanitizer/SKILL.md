...
- [Step-by-Step](#step-by-step)
  - [Step 1: Compile with ASan](#step-1-compile-with-asan)
  - [Step 2: Configure ASan Options](#step-2-configure-asan-options)
  - [Step 3: Run Your Program](#step-3-run-your-program)
  - [Step 4: Adjust Fuzzer Memory Limits](#step-4-adjust-fuzzer-memory-limits)
- [Common Patterns](#common-patterns)
  - [Pattern: Basic ASan Integration](#pattern-basic-asan-integration)
  - [Pattern: ASan with Unit Tests](#pattern-asan-with-unit-tests)
- [Advanced Usage](#advanced-usage)
  - [Tips and Tricks](#tips-and-tricks)
  - [Understanding ASan Reports](#understanding-asan-reports)
...
- [Tool-Specific Guidance](#tool-specific-guidance)
  - [libFuzzer](#libfuzzer)
  - [AFL++](#afl)
  - [cargo-fuzz (Rust)](#cargo-fuzz-rust)
  - [honggfuzz](#honggfuzz)
- [Troubleshooting](#troubleshooting)
- [Related Skills](#related-skills)
  - [Tools That Use This Technique](#tools-that-use-this-technique)
  - [Related Techniques](#related-techniques)
- [Resources](#resources)
  - [Key External Resources](#key-external-resources)
...
| **fuzz-coverage-analysis** | Coverage-guided fuzzing helps trigger code paths where ASan can detect memory errors |
