...
## Design Rationale (Absorbed)

For design decisions that are more UX/design-focused than architectural, use the same ADR format
with these additions:

- **Design Context**: Include user research findings, UX constraints, and design principles
- **Visual Options**: Reference mockups or wireframes for each alternative
- **Trade-offs**: Include usability vs. implementability vs. brand alignment

See [references/design-rationale-example.md](references/design-rationale-example.md) and
[references/design-rationale-template.md](references/design-rationale-template.md) for
