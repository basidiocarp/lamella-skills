...
- [Describe Commands](#describe-commands)
  - [atmos describe component](#atmos-describe-component)
  - [atmos describe stacks](#atmos-describe-stacks)
  - [atmos describe affected](#atmos-describe-affected)
  - [atmos describe dependents](#atmos-describe-dependents)
  - [atmos describe config](#atmos-describe-config)
  - [atmos describe workflows](#atmos-describe-workflows)
  - [atmos describe locals](#atmos-describe-locals)
- [List Commands](#list-commands)
  - [atmos list stacks](#atmos-list-stacks)
  - [atmos list components](#atmos-list-components)
  - [atmos list instances](#atmos-list-instances)
  - [atmos list affected](#atmos-list-affected)
  - [atmos list workflows](#atmos-list-workflows)
  - [Other List Commands](#other-list-commands)
- [Common Patterns](#common-patterns)
  - [Output Format Support](#output-format-support)
  - [Column Customization (List Commands)](#column-customization-list-commands)
  - [Sorting (List Commands)](#sorting-list-commands)
  - [YQ Query Filtering](#yq-query-filtering)
  - [Provenance Tracking](#provenance-tracking)
  - [Template and Function Control](#template-and-function-control)
  - [Authentication for Remote Resources](#authentication-for-remote-resources)
- [Introspection Workflow for AI Agents](#introspection-workflow-for-ai-agents)
