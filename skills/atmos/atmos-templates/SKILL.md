...
- [Overview](#overview)
- [Enabling Go Templates](#enabling-go-templates)
- [Template Context Variables](#template-context-variables)
- [Template Examples](#template-examples)
- [`atmos.Component` Template Function](#atmoscomponent-template-function)
- [`atmos.GomplateDatasource` Template Function](#atmosgomplatedatasource-template-function)
- [`atmos.Store` Template Function](#atmosstore-template-function)
- [Template Evaluations (Processing Pipelines)](#template-evaluations-processing-pipelines)
- [Excluding Templates from Processing](#excluding-templates-from-processing)
  - [Passing Templates to External Tools](#passing-templates-to-external-tools)
  - [Templates in Imports](#templates-in-imports)
- [Template Configuration in Stack Manifests](#template-configuration-in-stack-manifests)
- [When to Use Go Templates vs. YAML Functions](#when-to-use-go-templates-vs-yaml-functions)
...
In Go templates, reference any value from the component's configuration (as returned by
