...
- [Integrated MCP Servers](#integrated-mcp-servers)
  - [Bundled Servers](#bundled-servers)
- [When to Use This Skill](#when-to-use-this-skill)
- [Cost Optimization Best Practices](#cost-optimization-best-practices)
  - [Pre-Deployment Cost Estimation](#pre-deployment-cost-estimation)
...
- [Monitoring and Observability Best Practices](#monitoring-and-observability-best-practices)
  ...
  - [Container and Kubernetes Monitoring](#container-and-kubernetes-monitoring)
- [Audit and Security Best Practices](#audit-and-security-best-practices)
  - [CloudTrail Activity Analysis](#cloudtrail-activity-analysis)
  - [Security Assessment](#security-assessment)
- [Using MCP Servers Effectively](#using-mcp-servers-effectively)
  - [Cost Analysis Workflow](#cost-analysis-workflow)
  - [Monitoring Workflow](#monitoring-workflow)
  - [Security Workflow](#security-workflow)
  - [MCP Usage Best Practices](#mcp-usage-best-practices)
- [Operational Excellence Guidelines](#operational-excellence-guidelines)
  - [Cost Optimization](#cost-optimization)
  - [Monitoring and Alerting](#monitoring-and-alerting)
  - [Security and Compliance](#security-and-compliance)
- [Additional Resources](#additional-resources)
- [CloudWatch Alarms Reference](#cloudwatch-alarms-reference)
