...
description: "Builds cloud infrastructure with AWS Cloud Development Kit (CDK) in TypeScript or Python."
metadata:
  context: fork
  skills:
  - aws-mcp-setup
...
- [Core CDK Principles](#core-cdk-principles)
  - [Resource Naming](#resource-naming)
  - [Lambda Function Development](#lambda-function-development)
...
- [Using MCP Servers Effectively](#using-mcp-servers-effectively)
  - [When to Use AWS Documentation MCP](#when-to-use-aws-documentation-mcp)
  - [When to Use CDK MCP Server](#when-to-use-cdk-mcp-server)
  - [MCP Usage Best Practices](#mcp-usage-best-practices)
- [CDK Patterns Reference](#cdk-patterns-reference)
