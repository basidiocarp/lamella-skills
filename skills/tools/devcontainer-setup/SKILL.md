...
- [Workflow](#workflow)
- [Phase 1: Project Reconnaissance](#phase-1-project-reconnaissance)
  - [Infer Project Name](#infer-project-name)
  - [Detect Language Stack](#detect-language-stack)
  - [Multi-Language Projects](#multi-language-projects)
- [Phase 2: Generate Configuration](#phase-2-generate-configuration)
- [Base Template Features](#base-template-features)
- [Language-Specific Sections](#language-specific-sections)
  - [Python Projects](#python-projects)
  - [Node/TypeScript Projects](#nodetypescript-projects)
  - [Rust Projects](#rust-projects)
  - [Go Projects](#go-projects)
- [Reference Material](#reference-material)
- [Adding Persistent Volumes](#adding-persistent-volumes)
