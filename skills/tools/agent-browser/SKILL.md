...
- [Key Commands](#key-commands)
  ...
  - [Snapshots (Essential for AI)](#snapshots-essential-for-ai)
  - [Interactions](#interactions)
  - [Get Information](#get-information)
  - [Screenshots & PDFs](#screenshots-pdfs)
  - [Wait](#wait)
- [Semantic Locators (Alternative to Refs)](#semantic-locators-alternative-to-refs)
- [Sessions (Parallel Browsers)](#sessions-parallel-browsers)
- [Examples](#examples)
  - [Login Flow](#login-flow)
  - [Search and Extract](#search-and-extract)
  - [Form Filling](#form-filling)
  - [Debug Mode](#debug-mode)
- [JSON Output](#json-output)
- [vs Playwright MCP](#vs-playwright-mcp)
