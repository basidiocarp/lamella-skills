...
- [Overview](#overview)
- [Trigger Guidance](#trigger-guidance)
  - [Trigger Phrases](#trigger-phrases)
  - [Non-Trigger Examples](#non-trigger-examples)
- [Deterministic Execution Model](#deterministic-execution-model)
  - [Step 1: Preflight](#step-1-preflight)
  - [Step 2: Run Baseline Validation (Default Path)](#step-2-run-baseline-validation-default-path)
  - [Step 3: Load Only Needed References](#step-3-load-only-needed-references)
  - [Step 4: Provide or Apply Fixes](#step-4-provide-or-apply-fixes)
  - [Step 5: Rerun Policy (Mandatory After Changes)](#step-5-rerun-policy-mandatory-after-changes)
- [Fallback Behavior](#fallback-behavior)
- [Citation Guidance for Fixes](#citation-guidance-for-fixes)
- [Response Template](#response-template)
- [Example Flows](#example-flows)
  - [Fully Automated Environment](#fully-automated-environment)
  - [Deterministic CI Gate](#deterministic-ci-gate)
  - [Constrained Environment (No ShellCheck Runtime)](#constrained-environment-no-shellcheck-runtime)
- [Validator Script Details](#validator-script-details)
  - [Scripts](#scripts)
  - [Detection and Ordering](#detection-and-ordering)
...
- `docs/shellcheck-config.md` — .shellcheckrc setup, common SC codes, suppression patterns, CI integration, output formats
