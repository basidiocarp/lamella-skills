...
- [Captured Requirements](#captured-requirements)
- [Canonical Example Flows](#canonical-example-flows)
- [Done Criteria](#done-criteria)
- [Helper Scripts and Assets](#helper-scripts-and-assets)
...
- `docs/defensive-patterns.md` — strict mode, error trapping, safe arrays, atomic writes, idempotent design
