...
# Stage weights control how much each dimension contributes to the overall score.
STAGE_WEIGHTS = {
    Stage.SEED: {
...
def build_engineering_dimension(**kwargs) -> Dimension:
    # Deployment frequency is encoded as 5=multiple/day through 1=<monthly.
    return Dimension(
        key="engineering",
...
def build_sample_data(stage: Stage) -> Dict:
    """Build sample Series A company data."""
    return dict(
        # Financial
