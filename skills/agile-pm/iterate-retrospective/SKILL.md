...
- When capturing organizational lessons learned after projects or incidents
- When experienced team members leave (preserving institutional knowledge)
...
For significant learnings that transcend the team, capture a lessons log entry alongside the retrospective. Focus on knowledge that future teams need: patterns, anti-patterns, and hard-won wisdom.

**Lessons log template**: See `references/lessons-template.md`
**Lessons log example**: See `references/lessons-example.md`
